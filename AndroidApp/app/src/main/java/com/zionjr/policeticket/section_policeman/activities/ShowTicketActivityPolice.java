...
import com.zionjr.policeticket.databinding.ActivityShowTicketPoliceBinding;
...
public class ShowTicketActivityPolice extends AppCompatActivity {

    private ActivityShowTicketPoliceBinding binding;
    private Ticket ticket;

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        binding = ActivityShowTicketPoliceBinding.inflate(getLayoutInflater());
    ...
    private void initViews() {
        ...
        binding.textViewName.setText(ticket.getViolator().getName());

        binding.textViewLicenseNumber.setText(ticket.getViolator().getLicenseNumber());

        binding.textViewPlateNumber.setText(ticket.getViolator().getPlateNumber());
